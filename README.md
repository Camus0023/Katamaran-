...
Escucha sonidos que vienen de diferentes direcciones y presiona las teclas correspondientes al ritmo de la música:

| Tecla | Acción
|-----|-----
| **Flecha Izquierda** | Responder a sonido desde la izquierda
| **Flecha Arriba** | Responder a sonido desde el centro
| **Flecha Derecha** | Responder a sonido desde la derecha
